...
//@Entity
//@Table(name="user4") // map to database table user
...
@MappedSuperclass //仅仅在java model中存在继承关系，在DB中子类的表已经没有关系了
public abstract class User4 { //抽象类
	...
	// ���������ֶ�
	public User4(String firstName, String lastName, Date dateOfBirth, String email) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
